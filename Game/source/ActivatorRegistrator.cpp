...
std::map<std::string, targFun> ActivatorRegistrator::prefixToTarget =
{
	...
	{ "splitdoor_",  [](auto args, auto idToTarget, auto groupName) {return new Door(args, idToTarget, BOTH, groupName, true); } },
	{ "splitdoorPermanent_",  [](auto args, auto idToTarget, auto groupName) {return new Door(args, idToTarget, BOTH, groupName, false); } },
