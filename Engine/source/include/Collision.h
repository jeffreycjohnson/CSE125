...
public:
	...
	RayHitInfo raycast(const Ray&, float t_min = RAY_MIN, float t_max = RAY_MAX, const std::initializer_list<Collider*>& ignore = {});
...
private:
	...
	void raycast(const Ray&, RayHitInfo&, const std::initializer_list<Collider*>& ignore = {});
